...
private struct ChangeLogRootView: View {
    ...
    private let releasesURL = URL(string: "https://github.com/monokano/Glow-Ai/releases")!
...
private struct ChangeLogView: NSViewRepresentable {
    ...
    func makeNSView(context: Context) -> WKWebView {
        ...
        let urlStr = "https://tama-san.com/glee-glow-ai/change-log-\(lang).html?\(UUID().uuidString)"
